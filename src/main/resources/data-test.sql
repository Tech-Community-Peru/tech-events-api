...
INSERT INTO usuario (nombre, apellido, correo_electronico, contrasenia, habilidades, linkedin, informacion_adicional, ubicacion, pais_origen, edad, rol) VALUES
                                                                                                                                                        ('Juan', 'Pérez', 'juan.perez@example.com', 'password123', 'Java, Spring Boot', 'https://linkedin.com/in/juanperez', 'Desarrollador Backend', 'Lima', 'Perú', 30,'miembro'),
                                                                                                                                                        ('María', 'García', 'maria.garcia@example.com', 'password456', 'Python, Django', 'https://linkedin.com/in/mariagarcia', 'Arquitecta de Software', 'Santiago', 'Chile', 28,'administrador'),
                                                                                                                                                        ('Carlos', 'López', 'carlos.lopez@example.com', 'password789', 'SQL, Data Analysis', 'https://linkedin.com/in/carloslopez', 'Analista de Datos', 'Buenos Aires', 'Argentina', 35,'administrador');
...
INSERT INTO ubicacion (nombre_lugar, direccion, ciudad, pais, descripcion) VALUES
                                                                               ('Auditorio Principal', 'Av. Principal 123, Edificio A', 'Lima', 'Perú', 'Auditorio amplio con capacidad para 500 personas.'),
                                                                               ('Sala de Conferencias Norte', 'Calle Los Robles 456, Piso 2', 'Bogotá', 'Colombia', 'Sala equipada con proyector y sonido envolvente.'),
                                                                               ('Centro de Convenciones', 'Carretera Panamericana Norte km 50', 'Santiago', 'Chile', 'Espacio ideal para conferencias y exposiciones de gran tamaño.');
...
INSERT INTO evento (nombre, costo, descripcion, categoria_evento,tipo_evento,ponente_id,comunidad_id,ubicacion_id) VALUES
                                                                                                          ('Conferencia IA 2024', 150.00, 'Una conferencia sobre el futuro de la inteligencia artificial.','GESTIONTI', 'VIRTUAL', 1,1,2),
                                                                                                          ('Taller de UX/UI', 100.00, 'Aprende los fundamentos del diseño UX/UI.','GESTIONTI','VIRTUAL', 2,2,3),
                                                                                                          ('Hackathon de Ciberseguridad', 200.00, 'Evento competitivo enfocado en ciberseguridad.','GESTIONTI', 'PRESENCIAL',3,3,1);
...
INSERT INTO comentario (fecha_publicacion, comentario, evento_id, usuario_id,comunidad_id) VALUES
                                                                                  ('2024-09-15', '¡Excelente evento, aprendí mucho!', 1, 1,2),
                                                                                  ('2024-09-15', 'El ponente fue muy claro y directo.', 2, 2,1),
                                                                                  ('2024-09-15', 'Me gustaría que se extendiera más el tiempo.', 3, 3,2);
...
INSERT INTO usuario_comunidad (usuario_id, comunidad_id, fecha_unido) VALUES
                                                                               (1, 1, '2024-09-15 08:00:00'),
                                                                               (2, 1, '2024-09-16 09:00:00'),
                                                                               (3, 2, '2024-09-17 14:00:00');
