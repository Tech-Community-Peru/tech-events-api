...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    private UsuarioPerfilDTO registerUsuarioWithRole(UsuarioRegistroDTO usuarioRegistroDTO, Role roleENUM) {
        ...
        boolean existCorreo= userRepository.existsByCorreoElectronico(usuarioRegistroDTO.getCorreo());
        boolean existAsParticipante = participantRepository.findByNombreAndApellido(usuarioRegistroDTO.getNombre(), usuarioRegistroDTO.getApellido()) ;
        ...
        Roles role = rolesRepository.findByNombre(roleENUM)
